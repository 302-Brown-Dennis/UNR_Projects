...
class MountainCar:
    def __init__(self, env_id, train, test, model, render=False):
        ...
        self.num_bins = [11,     11]  # This needs to be changed
    ...
    def run(self):
        ...
        alpha = 0.15  # This needs to be changed
        gamma = 0.65  # This needs to be changed
        # epsion-greedy params
        eps_start = 0.9
        eps_end = 0.05
        eps_decay = 100000
        if self.train:
            n_episodes = 5001     # This might need to be changed
            time_ = 1
